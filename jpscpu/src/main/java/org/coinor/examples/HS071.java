...
public class HS071 extends Ipopt {
    ...
    public static void main(String[] args) {
        HS071[] hs071s = new HS071[10];
        for (int i = 0; i < 10; i++) {
            // Create the problem
            hs071s[i] = new HS071();
            HS071 hs071 = hs071s[i];
    ...
    public static void print(double[] x, String str) {
